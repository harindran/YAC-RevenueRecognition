CREATE Procedure "ATPL_GetRevenueDetails" (IN fdate timestamp,IN ProjectType varchar(50)) as
...
Round((B."Total Cost Current Month"/(B."Total Cost Current Month"+(B."Estimated Cost"-B."Total Cost Current Month"))* B."Revised Contract Value"- B."Previous Revenue"),2) "Revenue Current Month",
...
from (Select 'N' as "Select", T1."Code" "Contract Number",T1."U_ProjType"  "Type",T1."U_Type" "Com/Res",T1."U_Status"  "Status",
