...
( Select  SUM((Select Sum("U_NetAdd")-Sum("U_NetDed") from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_SOEntry"=T0."DocEntry" and "U_SOEntry" is not null)) 
from ORDR T0 Where T0."DocEntry" in (Select "U_SOEntry" from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_SOEntry"<>'') and T0."DocDate"<=:fdate )  "Variation Omission",


--(((Select Sum("U_IProjValue") from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_Origin"='Y') +(Select Sum("U_NetAdd")-Sum("U_NetDed") from "@AT_PROJMSTR1" Where "Code"=T1."Code"))  "Revised Contract Value",

(Select Sum("U_IProjValue") from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_Origin"='Y') + ( Select  SUM((Select Sum("U_NetAdd")-Sum("U_NetDed") from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_SOEntry"=T0."DocEntry" and "U_SOEntry" is not null)) 
from ORDR T0 Where T0."DocEntry" in (Select "U_SOEntry" from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_SOEntry"<>'') and T0."DocDate"<=:fdate ) "Revised Contract Value", 

--(T1."U_EstProjValue") "Estimated Cost",

(Select SUM(ifnull((Select Sum("U_Total") from "@AT_PROJMSTR3" Where "Code"=T1."Code" and "U_SOEntry"=T0."DocEntry" and "U_SOEntry" is not null ),0) +
ifnull((Select Sum("U_Total") from "@AT_PROJMSTR4" Where "Code"=T1."Code" and "U_SOEntry"=T0."DocEntry" and "U_SOEntry" is not null ),0) )
 from ORDR T0 Where T0."DocEntry" in (Select "U_SOEntry" from "@AT_PROJMSTR1" Where "Code"=T1."Code" and "U_SOEntry"<>'')
 and T0."DocDate"<=:fdate) "Estimated Cost",

ifnull(T1."U_PrevRevenue",0) "Previous Revenue",ifnull(T1."U_PrevCost",0)  "Previous Cost",
...
Group by T1."Code",T1."U_ProjType",T1."U_Type",T1."U_Status",T1."U_ConDesc",T1."U_PrevRevenue",T1."U_PrevCost"
) A) B 
